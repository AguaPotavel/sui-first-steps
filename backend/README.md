...
Você pode navegar até aqui a partir do diretório superior usando:
```sh
cd backend
```
...
> :information_source: Lembre-se de ler as instruções para resolver os exercícios, bem como fazer a instalação dos recursos necessários descritos no repositório principal.